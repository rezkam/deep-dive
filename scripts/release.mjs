...
writeFileSync("/tmp/deep-dive-release-notes.md", releaseNotes);
run(
	`gh release create v${version} --title "v${version}" --notes-file /tmp/deep-dive-release-notes.md`
);
console.log();
